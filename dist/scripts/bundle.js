...
var AboutView = React.createClass({displayName: "AboutView",
  render: function() {
    return (
      React.createElement("h1", null, "AboutView")
    )
  }
})
...
var AppViewController = React.createClass({displayName: "AppViewController",
  render: function(){
    return (
...
var AuthorsIndexView = React.createClass({displayName: "AuthorsIndexView",
		render: function() {
			...
			return (
				React.createElement("div", null, 
					React.createElement("h1", null, "Authors Index"), 
					...
					React.createElement("table", {className: "table"}, 
						...
						React.createElement("tbody", null, 
							React.createElement("tr", null, 
								...
								React.createElement("td", null, "Billy Tomkins"), 
								React.createElement("td", null, "billy-tomkins")
							)
						)
					)
...
},{"../../_api":197,"react":196}],201:[function(require,module,exports){
var React = require('react')

var HomeViewController = React.createClass({displayName: "HomeViewController",
  render: function() {
    return (
...
var NotFoundView = React.createClass({displayName: "NotFoundView",
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement("h1", null, "NOOOO!!!!!! Not found!!!")
      )
    )
  }
});
...
var appRoutes = (
    React.createElement(Route, {name: "app", path: "/", handler: AppViewController}, 
      React.createElement(DefaultRoute, {handler: HomeView}), 
      React.createElement(Route, {name: "about", path: "/about", handler: AboutView}), 
      React.createElement(Route, {name: "author", path: "/authors", handler: AuthorsIndexView}), 
...
},{"./components/about/component-about-page.jsx":198,"./components/app.js":199,"./components/authors/components-authors-index.jsx":200,"./components/component-home-page.jsx":201,"./components/component-not-found.jsx":202,"react":196,"react-router":27}]},{},[203]);
