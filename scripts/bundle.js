  ...
  render: function() {
    return (
      React.createElement("header", null, 
          React.createElement("link", {rel: "shortcut icon", type: "image/x-icon", href: "../favicon.ico"}), 
          React.createElement("div", {className: "title"}, 
              React.createElement("a", {href: "#home"}, 
                  React.createElement("div", {className: "beer-cast-icon"}, 
                      React.createElement("i", {className: "fa fa-beer fa-4x beer-ike"}), 
                      React.createElement("i", {className: "fa fa-cloud fa-lg cloud-ike"}), 
                      React.createElement("i", {className: "fa fa-sun-o fa-lg sun-ike"})
                  ), 
                  React.createElement("h1", null, "Beercast")
              )
          ), 
          React.createElement("div", {className: "searchBar"}, 
              React.createElement("form", {id: "submitForm"}, 
                  React.createElement("span", null, 
                  React.createElement("input", {type: "text", name: "searchBar", placeholder: "Search for Breweries near..."}), 
                    React.createElement("input", {type: "submit", className: "submit", name: "submit"}), 
          ...
          React.createElement("ul", {className: "navigation"}, 
              ...
              React.createElement("a", {href: "#searchCity"}, 
...
var MainView = React.createClass({displayName: "MainView",
  render: function() {
    return (
      React.createElement("div", {id: "ws-main", className: "CnWsFeatures TbWsFeat CnWsRates TbWsRates CnWsRooms TbWsRooms"}, 
        React.createElement("section", {id: "MyRetrieve_dvWsRetrieve", className: "ws-component ws-collapsible ws-show-this"}, 
          React.createElement("form", {id: "fmRetrieve"}, 
          React.createElement("div", {className: "ws-inner"}, 
            React.createElement("div", {className: "ws-item"}, 
              React.createElement("h1", {id: "MyRetrieve_hdGetResv"}, "View or Change a Reservation"), 
              React.createElement("p", {id: "MyRetrieve_txGetResv", className: "ws-desc"}, "You will need to provide the information below to find your reservation. Once found, you can then modify or cancel that reservation online.")
            ), 
            React.createElement("div", {className: "ws-item"}, 
              React.createElement("div", {className: "ws-form-item"}, 
                React.createElement("label", {id: "MyRetrieve_lbRetrLastName"}, "Last Name ", React.createElement("span", {className: "ws-required"}, "*")), 
                React.createElement("input", {type: "text", id: "txRetrLastName", className: "ws-element"}), 
                React.createElement("p", {className: "ws-error"})
              ), 
              React.createElement("div", {className: "ws-form-item"}, 
                React.createElement("label", {id: "MyRetrieve_lbRetrConfirm"}, "Confirmation Number ", React.createElement("span", {className: "ws-required"}, "*")), 
                React.createElement("input", {type: "text", id: "txRetrConfirm", className: "ws-element"}), 
                React.createElement("p", {className: "ws-error"})
              ), 
              React.createElement("div", {className: "ws-buttons"}, 
                React.createElement("a", {href: "#", id: "MyRetrieve_buGetResv", className: "ws-button ws-primary buWsGetResv"}, "FIND"), 
                React.createElement("input", {type: "submit", id: "buRetrieveSubmit", style: buRetrieveSubmitStyles, value: "Submit"})
              )
            ), 
            React.createElement("p", {className: "ws-close"}, React.createElement("a", {href: "#", id: "MyRetrieve_buGetResvClose", className: "buWsGetResvClose"}, React.createElement("b", {className: "ws-icon", "data-icon": ""}, "Close")))
          )
          )
        ), 
        React.createElement("section", {id: "ws-cart-view", className: "ws-component ws-collapsible ws-show-this"}, 
          React.createElement("div", {className: "ws-inner"}, 
            React.createElement("h1", {id: "dvWsCartMsg1"}, " "), 
            React.createElement("p", {id: "dvWsCartMsg2"}, " "), 
            React.createElement("p", {className: "ws-buttons"}, 
              React.createElement("a", {href: "cart.aspx?hotelID=1002&langID=1", id: "buCart", className: "ws-button ws-primary"}, "View Cart and Checkout"), 
              React.createElement("span", {className: "ws-close"}, React.createElement("a", {href: "#", id: "buCartCont", className: "ws-button ws-secondary"}, "Continue Shopping"))
            )
          )
        ), 
        React.createElement("div", {id: "dvMessage", className: "ws-messages ws-msg-error ws-collapsible"}), 
        React.createElement("div", {className: "ws-show-hide-component", id: "ws-sh-itinerary"}, 
          React.createElement("a", {href: "#", className: "ws-alpha ws-itinerary-summary"}, 
            React.createElement("span", {id: "spMoUpdateResults", className: "ws-itinerary-info"}, 
            React.createElement("span", {id: "spMoUpdateResultsDest", className: "ws-pre"}), " Wed, Feb 3 - Thu, Feb 4, 1 night"
            ), 
            React.createElement("span", {className: "ws-edit"}, React.createElement("b", {id: "buMoEdit", className: "ws-button-small ws-primary"}, "Edit"))
          ), 
          React.createElement("a", {href: "#", className: "ws-omega"}, React.createElement("strong", {id: "buMoItinerary"}, "Your Itinerary"), React.createElement("b", {className: "ws-icon", "data-icon": ""}))
        )
      )
    )
  }
...
// var NissanComponent = require('./components/nissanParts.js');
...
// React.render(<Homeview/>, document.querySelector('.react-container') )
...
React.render(React.createElement(Homeview, null), document.querySelector('.react-container') )

},{"./components/footer.js":157,"./components/header.js":158,"./components/wsmain.js":159,"react":156}]},{},[160]);
